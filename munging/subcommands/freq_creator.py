...
def action(args):
    ...
    controls = ['LMG-098', 'LMG-098A', 'LMG-098B', 'C066N', 'LMG-240', 'LMG-240A', 'LMG-240B', 'OPX-240', 'OPX-240A', 'OPX-240B','LMG-241', 'CON-0001T', 'CON-0003T', 'LMG-240-1-10', 'CON-0228T', 'CON-762R']
    ...
    for row in tallies:
        ...
        row['freq'] = '%.02f' % (float(row['tally'])/sample_count)
        writer.writerow(row)
