...
file_types = {
    ...
    'gatk.hg19_snp138_dropped':({1:'rsid_1'}, [2, 3, 4, 5, 6]),
...
def action(args):
    ...
    for data in sorted(output.values(), key = sort_key):
        ...
        data['1000g_ALL']=data.get('1000g_ALL') or None
        data['1000g_AMR']=data.get('1000g_AMR') or None
        data['1000g_SAS']=data.get('1000g_SAS') or None
