"""
Compare sample MSI loci count to the in-run HapMap MSI loci count

Usage:

munge msi_sample_vs_control  /path/to/control/msi/file /path/to/sample/msi/file -o output_file
