...
class TestParsers(TestBase):
    ...
    def testSNPParser(self):
        ...
        self.assertListEqual(sorted(prefixes),sorted(['5437_NA12878_Ref|Var','6037_NA12878_Ref|Var','0228T_Ref|Var','4902_Ref|Var','4929_Ref|Var']))
        self.assertListEqual(sorted(fieldnames), sorted(['Position', 'Ref_Base', 'Var_Base', 'Gene', 'Variant_Type',
                                         ...
                                         '5437_NA12878_Ref|Var', '0228T_Ref|Var','4902_Ref|Var','4929_Ref|Var']))
    ...
    def testQualityParser(self):
        ...
        chosen_parser='{}(files, specimens, annotation, prefixes, variant_keys)'.format(analysis_type)
        specimens, annotation, prefixes, fieldnames, variant_keys=eval(chosen_parser)        
        self.assertListEqual(fieldnames, ['MEAN_TARGET_COVERAGE', '4902', '4929'])
        self.assertListEqual(variant_keys, ['MEAN_TARGET_COVERAGE'])
        self.assertListEqual(sorted(prefixes),sorted(['4902','4929']))
    ...
    def testMSIParser(self):
        ...
        self.assertListEqual(sorted(prefixes),sorted(['0228T', '5437_NA12878', '4936_NA12878']))
        self.assertListEqual(sorted(fieldnames), sorted(['0228T', '5437_NA12878', '4936_NA12878', 'Position']))
