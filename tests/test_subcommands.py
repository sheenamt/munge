...
class TestControlParser(TestBase):
    ...
    def testControlParserMatch(self):
        ...
        runfname = open(path.join(analysis_testfiles,control, '{}.SNP_Analysis.txt').format(control))
...
class TestMasker(TestBase):
    ...
    def testMaskFileByGene(self):
        ...
        """
        data=csv.DictReader(open(path.join(analysis_testfiles,'0228T_CON_OPXv4_INT/0228T_CON_OPXv4_INT.SNP_Analysis.txt')), delimiter='\t')
        genes=('BRCA1','BRCA2')
